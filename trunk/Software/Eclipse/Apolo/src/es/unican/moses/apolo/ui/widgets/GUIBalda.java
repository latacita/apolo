...
public class GUIBalda extends JPanel {
	...
	private void inicializacion(){
		...
		bt_acciones.setToolTipText("Otras Opciones");
	...
	public void setNumBalda(int n){
		setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Balda " + n, TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
	}
