...
El objetivo del presente proyecto fin de carrera para acceder al titulo de Ingeniería Informática de la Universidad de Cantabria,  es crear una aplicación software sencilla, usable y ligera para la clasificación de un conjunto de imágenes digitales. \newline

La interfaz gráfica de dicha aplicación deberá ser lo más parecida posible a un clasificador retroiluminado de diapositivas analógicas. El usuario deberá interactuar con la aplicación como si un clasificador de este tipo se tratase. Una vez seleccionadas clasificadas y ordenadas las fotografías de una colección de imágenes, la aplicación debe permitir exportarlas a una carpeta concreta como un conjunto de archivos, ordenadas de manera adecuada.
\newline

Las aplicaciones existentes actualmente no tienen como finalidad principal la ordenación y clasificación de fotografías, por lo que, aunque muchas de ellas son capaces de clasificar y ordenar fotografías, no permiten renombrar las imágenes de manera efectiva, y para su ejecución requieren gran cantidad de recursos del sistema.
\newline

El finalidad del proyecto es crear un software capaz clasificar y organizar fotografías con un consumo de recursos bajo y una curva de aprendizaje muy suave.
\newline

El software será desarrollado en Java, utilizando un desarrollo basado en componentes, adoptando una metodología iterativa e incremental.
