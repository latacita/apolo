...
\label{sec:despliegueAceptacion:despliegue}
    ...
    \subsection{Creación de la web}
        Se aprovecho la web que ofrece el servicio de \emph{Google Code} para alojar la web de Apolo, así como las descargas de los instalándose y el código fuente.

        Esta web se crea para dar una presentación en internet a la aplicación, así como alojar las descargas, de manera que puedan descargarse directamente de internet. Además nos dará la posibilidad de conocer los visitantes de la web y su procedencia, así como el numero de descargas realizadas.
