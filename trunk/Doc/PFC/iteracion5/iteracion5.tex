...
\chapterheader{Quinta Iteración}{Quinta Iteración}
...
A consecuencia del análisis de requisitos de esta iteración surgieron una serio de refinamiento en los requisitos iniciales, así como nuevos requisitos.
...
\label{sec:iteracion5:diagramaDeClases}
...
\label{sec:iteracion5:implementacion}
    ...
    Para proceder con la implementación de esta iteración, lo primero que se hizo diseñar y posteriormente crear el ultimo componente de la aplicación. La zona \emph{Album o de subsecuencias ordenadas}. una vez creada se añadió al resto de la aplicación y se comprobó su correcta integración en el sistema.

    Una vez integrada se comenzó a enlazar el nuevo componente con los ya presentes de manera que respondiera a los eventos necesarios para la correcta inclusion en el sistema. De esta forma, se programó que al pulsar el botón de alguna balda, las diapositivas depositadas en ella, fueran enviadas al nuevo componente, para que este las incluyera en si, de manera que mostrara dicha subsecuencia habida en la balda.
...
%%%%%%%%%%%%*****************
%% Hablar del bean paquetedediapositivas?¿?
%%%%%%%%%%%%*****************
...
\label{sec:iteracion5:pruebas}
    ...
    \begin{enumerate}
        \item Añadir balda como subsecuencia ordenada:
            \begin{description}
            \item[Resultado Esperado] Aparición de la representación de la subsecuencia ordenada en la parte alta de la aplicación.
            \item[Resultado Obtenido] Aparición de la representación de la subsecuencia ordenada en la parte alta de la aplicación. (Correcto)
        \end{description}

        \item Intentar añadir una subsecuencia vacía:
            \begin{description}
                \item[Resultado Esperado] Mensaje de error, informando de lo ocurrido.
                \item[Resultado Obtenido] Mensaje de error, informando de lo ocurrido. (Correcto)
            \end{description}

        \item Añadir nombre o descripción a la balda:
            \begin{description}
                \item[Resultado Esperado] Renombre de la balda.
                \item[Resultado Obtenido] Renombre de la balda. (Correcto)
            \end{description}

        \item Añadir balda con descripción como subsecuencia ordenada:
            \begin{description}
                \item[Resultado Esperado] Aparición de la representación de la subsecuencia en la zona superior con la descripción.
                \item[Resultado Obtenido] Aparición de la representación de la subsecuencia en la zona superior con la descripción. (Correcto)
        \end{description}

        \item Convertir subsecuencia ordenada en balda:
            \begin{description}
                ...
                \item[Resultado Obtenido] Aparición de un mensaje y tras su confirmación, creación de una balda conteniendo todas las diapositivas que había ordenadas. (Correcto)
        \end{description}
        ...
        \item Convertir subsecuencia ordenada con descripción en balda:
            \begin{description}
                ...
                \item[Resultado Obtenido] Aparición de un mensaje y tras su confirmación, creación de una balda con descripción conteniendo todas las diapositivas que había ordenadas. (Correcto)
        \end{description}
        
        \item Eliminar una balda:
            \begin{description}
                ...
                \item[Resultado Obtenido] Aparición de un mensaje solicitando confirmación de la acción y en su caso, desaparición de la balda y todas las diapositivas que contenía, de contenerlas. (Correcto)
        \end{description}
    \end{enumerate}
