...
JavaBeans\cite{java2,javac2} es la tecnología de componentes de Java, cada componente se le conoce como bean, un bean no es más que una clase de objetos con unas características especiales:
