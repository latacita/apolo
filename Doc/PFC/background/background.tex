...
\begin{enumerate}
	\item Es una clase pública que implementa la interfaz serializable.
...
En la siguiente sección se describe el proceso que se adoptará para mostrar el efecto de \emph{Drag and Drop} en la aplicación.
...
Al detener el arrastre del componente y soltar el botón izquierdo del ratón, el controlador desactivará el panel de \emph{cristal} y lanzará un evento a todos los componentes en los que se pueda depositar el elemento arrastrado.
