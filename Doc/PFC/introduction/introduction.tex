...
\section{Motivaciï¿½n and Contribuciones}
\label{sec:intr:motivation}

TODO: Esta secciï¿½n es mï¿½s para tesis doctorales que para proyectos fin de carrera. La dejamos de momento pero se podrï¿½a eliminar

\section{Visiï¿½n General del Proyecto}
\label{sec:intr:overview}

TODO: Esto estï¿½ bien dejarlo, pero tambiï¿½n es suprimible
