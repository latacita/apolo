...
posibilidad de ordenar cómodamente sus fotografías, así como descartar las que no satisfagan la calidad esperada o deseada.
...
%%************************
%%    Mezclo diapositiva y fotografia.
%%    Estaria bien definir un unico nombre.
%%************************
...
\item El usuario puede a partir de ese momento empezar a seleccionar las fotografías que considere adecuadas y arrastrarlas hasta la parte central de la aplicación, en esta zona se encuentran una especie de estanterías, o baldas, donde depositar la diapositiva arrastrada.
...
\item En la zona superior se puede reordenar subsecuencias de fotografías, es decir, una subsecuencia recién añadida, y por lo tanto al final de todas las subsecuencias, puede ser recolocada entre estas.
...
\item El usuario podrá por medio de los ficheros guardados crear albums de fotos de manera rápida. Solo deberá abrir el fichero que contiene la clasificación y orden de las fotografías y exportarlas a una carpeta.
\end{enumerate} 
