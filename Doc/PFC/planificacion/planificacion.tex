...
En este capitulo se describe la planificación que tendrá el proyecto, mostrando en líneas generales su ámbito funcional, la metodología de desarrollo utilizada, las iteraciones programadas, los requisitos de alto nivel de la aplicación, el diseño de los artefactos base, y las herramientas utilizadas para la construcción de prototipos.
