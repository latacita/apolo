...
%
\setlength{\oddsidemargin}{0.3in}%{70pt}     %{0.3in}     % left margin for odd (right) pages
\setlength{\evensidemargin}{0.3in}%{22pt}    %{0.3in}    % left margin for even (left) pages
\setlength{\textwidth}{6in}%{360pt}        %{6in} % width of the text body
