...
\label{sec:iteracion1:pruebas}
    ...
    \begin{enumerate}
        ...
        \item Importar varias Fotografías:
            \begin{description}
                ...
                \item[Resultado Obtenido] Aparición de la interfaz visual de la diapositiva por cada una de las fotografías importadas, en la interfaz visual de la mesa. (Correcto)
            \end{description}
