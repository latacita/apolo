...
\label{sec:iteracion1:casosDeUso}
    ...
    Un usuario debe poder importar ua fotografía a la aplicación, y que una vez seleccionada esta aparezca en la mesa. Este es el primer caso de uso detectado.
...
\label{sec:iteracion1:implementacion}
    ...
    Posteriormente se implemento el resto de componentes necesarios para la realización de la primera iteración, esto es: un menu desde el que se ofrezca la opción de importar fotografía, un menu en cada diapositiva para poder descartarla o visualizarla. Para visualizarla, se opto por ejecutar el programa que tenga el sistema operativo por defecto a esa tarea.
...
\label{sec:iteracion1:pruebas}
    ...
    \begin{enumerate}
        ...
        \item Visualizar Fotografía:
            \begin{description}
                \item[Resultado Esperado] Visualización de la diapositiva en programa por defecto del sistema operativo.
                \item[Resultado Obtenido] Visualización de la diapositiva en programa por defecto del sistema operativo. (Correcto)
            \end{description}
