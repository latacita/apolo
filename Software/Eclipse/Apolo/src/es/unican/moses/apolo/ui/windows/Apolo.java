...
public class Apolo {
	...
	public Apolo() {
		if(Toolkit.getDefaultToolkit().getScreenSize().width < 1024 || Toolkit.getDefaultToolkit().getScreenSize().height < 768){
			int respuesta = JOptionPane.showConfirmDialog(null,"Su resolucion es menor que 1024x768, apolo fue diseñado para resoluciones mayores. ¿Desea ejecutarlo?", "Resolucion no adecuada", JOptionPane.YES_NO_OPTION);
