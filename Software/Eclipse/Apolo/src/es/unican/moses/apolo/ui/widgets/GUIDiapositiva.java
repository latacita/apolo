...
import es.unican.moses.apolo.ui.windows.DialogoVisorImagenes;
        	...
        	public void mouseClicked(MouseEvent e) {
        		if (e.getClickCount() == 2 && e.getButton() == MouseEvent.BUTTON1) {
        			//se ha hecho dos click con el boton primero (izquierdo)
        				new DialogoVisorImagenes(gui_mesa.getlistaGUIDiapositivas(),Integer.parseInt(label_numero.getText())-1);
        			}
        	}
        });
    }
