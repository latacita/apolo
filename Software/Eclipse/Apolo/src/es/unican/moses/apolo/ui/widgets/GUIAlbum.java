...
public class GUIAlbum extends JPanel implements Serializable{
	...
	/**
	 * Añade un paquete de fotos al album
	 * @param listaDiapositivas
	 * @param descripcion
	 */
	public void addListaFotos(LinkedList<GUIDiapositiva> listaDiapositivas, String descripcion){
		GUIListaDiapositivas pagAlbum = new GUIListaDiapositivas(listaDiapositivas, this);
	...
	public void addGUIListaDiapositivas(GUIListaDiapositivas listadiapo){
	 ...
	 */
	public void desempaquetar(GUIListaDiapositivas paquete){
	...
	public void eliminaPaquete(GUIListaDiapositivas paquete){
