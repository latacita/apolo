...
import es.unican.moses.apolo.gui.GUIEstanterias;
...
public class Apolo {
	...
	private void initialize() {
		...
		gridBagLayout.rowHeights = new int[]{150, 200, 200, 0};
		...
		GUIEstanterias estanterias = new GUIEstanterias(componentAdapter);
